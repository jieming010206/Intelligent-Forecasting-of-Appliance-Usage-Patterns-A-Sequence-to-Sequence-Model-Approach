...
class Decoder(nn.Module):
    ...
    def forward(self, inputs, h_0, c_0):
        ...
        return time_outputs, appliance_outputs, h_n, c_n
...
class Model(nn.Module):
    ...
    def forward(self, inputs, targets=None, ratio = 0.3):
        ...
        encoder_outputs, h_n, c_n = self.encoder(encoder_inputs)
        ...
        for t in range(self.output_seq_len):
            ...
            decoder_time_outputs, decoder_appliance_outputs, h_n, c_n = self.decoder(decoder_inputs, h_n, c_n)
